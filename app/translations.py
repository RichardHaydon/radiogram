...
EN: dict[str, str] = {
    ...
    "button.cal_dim": "CAL DIM ({value})",
    "button.cal_bright": "CAL BRIGHT ({value})",
    ...
    "weather.tap_to_set": "Set location",
    "weather.search_placeholder": "Type a city, then SEARCH",
    "weather.search_hint": "Type a city above and tap SEARCH.",
    "weather.search_busy": "Searching…",
    "weather.search_no_results": "(no matches — try a different spelling)",
    "weather.search_error": "Error: {message}",
...
ES: dict[str, str] = {
    ...
    "button.cal_dim": "CAL OSC ({value})",
    "button.cal_bright": "CAL BRI ({value})",
    ...
    "weather.tap_to_set": "Elegir ubicacion",
    "weather.search_placeholder": "Escribe una ciudad y pulsa BUSCAR",
    "weather.search_hint": "Escribe una ciudad y pulsa BUSCAR.",
    "weather.search_busy": "Buscando…",
    "weather.search_no_results": "(sin resultados — prueba otra grafia)",
    "weather.search_error": "Error: {message}",
...
NO: dict[str, str] = {
    ...
    "button.cal_dim": "KAL MØRK ({value})",
    "button.cal_bright": "KAL LYS ({value})",
    ...
    "day.short.sun": "Son",
    "day.long.mon": "Mandag",
    "day.long.tue": "Tirsdag",
    "day.long.wed": "Onsdag",
    "day.long.thu": "Torsdag",
    "day.long.fri": "Fredag",
    "day.long.sat": "Lordag",
    "day.long.sun": "Sondag",
    "day.letter.mon": "M",
    ...
    "weather.tap_to_set": "Velg sted",
    "weather.search_placeholder": "Skriv en by, og trykk SOK",
    "weather.search_hint": "Skriv en by og trykk SOK.",
    "weather.search_busy": "Soker…",
    "weather.search_no_results": "(ingen treff — prov en annen stavemate)",
    "weather.search_error": "Feil: {message}",
